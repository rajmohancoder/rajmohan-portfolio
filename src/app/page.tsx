            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx}>
                    <h3 className="font-bold font-display text-sm uppercase">{edu.school}</h3>
                    <p className="text-xs italic text-primary font-bold">{edu.degree}</p>
                    <p className="text-xs text-primary mb-1">{edu.years}</p>
